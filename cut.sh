...
ffmpeg -y -ss 00:00:02.5 -i "${source_folder}/3.mp4"  -t 7 "${output_folder}/05.mp4"
ffmpeg -y -ss 00:00:22 -i "${source_folder}/3.mp4"  "${output_folder}/06.mp4"
ffmpeg -y -ss 00:00:00 -i "${source_folder}/4.mp4"  -t 4 "${output_folder}/07.mp4"
ffmpeg -y -ss 00:00:37.5 -i "${source_folder}/4.mp4"  -t 23.5 "${output_folder}/08.mp4"
ffmpeg -y -ss 00:00:00 -i "${source_folder}/5.mp4"  -t 21.2 "${output_folder}/09.mp4"
